...
<head>
    ...
    <link rel="stylesheet" href="/WEB_GR4/public/assets/css/style_admin.css">
...
<div class="admin-layout">
    <aside class="admin-sidebar">
        ...
        <ul class="admin-menu">
            ...
            <li><a href="#" disabled title="Coming soon"><i class="fas fa-shopping-cart"></i> Đơn hàng</a></li>
            <li><a href="#" disabled title="Coming soon"><i class="fas fa-users"></i> Người dùng</a></li>
            <li><a href="#" disabled title="Coming soon"><i class="fas fa-chart-bar"></i> Thống kê</a></li>
...
<script src="/WEB_GR4/public/assets/js/admin_home.js"></script>
</body>
</html>