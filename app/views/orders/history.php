...
<div class="orders-page">
    ...
    <div class="orders-stats">
        ...
        <div class="orders-stat-card stat-paid">
            <div class="orders-stat-number"><?= $paid ?></div>
            <div class="orders-stat-label">Đã thanh toán</div>
        </div>
                    ...
                    <tbody>
                        <?php foreach ($orders as $order): ?>
                            <tr class="clickable-row" data-href="/WEB_GR4/orders/<?= $order['order_id'] ?>">
                                ...
                                <td><?= htmlspecialchars($order['product_names'] ?? 'Chưa có sản phẩm') ?></td>
                                <td>
